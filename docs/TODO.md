...
- Pattern DANCE (2026-09-15): groove classico sempre in levare — core 4 note (2/6/10/14: tapado/open), leggeri slap che variano fra le barre. A≠B≠C≠D=A (frase di 4 bar chiusa) + Fill. Variazione musicale senza perdere il groove classico. Layout compatto: pallini quarti ridotti a 48–80px di altezza, spazio liberato per START/STOP e misure. Compilato.
