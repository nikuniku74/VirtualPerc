...
(`BeatTracker::updateAutoOctave`, `Source/Tracking/BeatTracker.cpp:573`), and a
listener's manual choice stands (`setTempoOctave`). Do not try to "fix" the
octave in the decoder.
